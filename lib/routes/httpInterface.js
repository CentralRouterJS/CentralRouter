                ...
                if(callback[0]) {
                    ...
                    httpInterface.getRequest( virtualDomainAddress, io, reqRoute, (callback) => {
                        if (callback.fileStream === false) {
                            ...
                            res.status(200).end(`${callback.responseData}`);
                            return;
                            ...
                            res.status(500).end(`500 ${appLocale.interfaces.http_interface.method_is}`);
                            return;
                        }
                    });
                } else {
                    ...
                    res.status(502).end(`502 ${appLocale.interfaces.http_interface.method_bg}`);
                }
            });
        }
    });
