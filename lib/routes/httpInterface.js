                ...
                if(callback[0]) {
                    ...
                    httpInterface.getRequest( virtualDomainAddress, io, reqRoute, (callback) => {
                        if(callback == undefined) {
                            console.log(`${appLocale.interfaces.http_interface.get_method} 
                                ${reqRoute} ${appLocale.interfaces.http_interface.method_arrow} 
                                ${subDomain}. 500 ${appLocale.interfaces.http_interface.method_is}`);
                            res.status(500).send(`500 ${appLocale.interfaces.http_interface.method_is}`);
                        }
                        console.log(`${appLocale.interfaces.http_interface.get_method}
                                ${reqRoute} ${appLocale.interfaces.http_interface.method_arrow}
                                ${subDomain}. 200 ${appLocale.interfaces.http_interface.method_ok}`);
                        res.status(200).send(`${callback}`);
                    });
                } else {
                    console.log(`${appLocale.interfaces.http_interface.get_method}
                            ${reqRoute} ${appLocale.interfaces.http_interface.method_arrow}
                            ${subDomain}. 502 ${appLocale.interfaces.http_interface.method_bg}`);
            ...
            serverManager.findOneByName(subDomain, (callback) => {
                if(callback[0]) {
                    ...
                    httpInterface.postRequest( virtualDomainAddress, io, reqRoute, (callback) => {
                        console.log(`${appLocale.interfaces.http_interface.post_method} 
                                ${reqRoute} ${appLocale.interfaces.http_interface.method_arrow} 
                                ${subDomain}. 200 ${appLocale.interfaces.http_interface.method_ok}`);
                        res.status(200).send(`${callback}`);
                    });
            ...
            serverManager.findOneByName(subDomain, (callback) => {
                if(callback[0]) {
                    ...
                    httpInterface.putRequest( virtualDomainAddress, io, reqRoute, (callback) => {
                        console.log(`${appLocale.interfaces.http_interface.put_method} 
                                ${reqRoute} ${appLocale.interfaces.http_interface.method_arrow} 
                                ${subDomain}. 200 ${appLocale.interfaces.http_interface.method_ok}`);
                        res.status(200).send(`${callback}`);
                    });
            ...
            serverManager.findOneByName(subDomain, (callback) => {
                if(callback[0]) {
                    ...
                    httpInterface.deleteRequest( virtualDomainAddress, io, reqRoute, (callback) => {
                        console.log(`${appLocale.interfaces.http_interface.delete_method} 
                                ${reqRoute} ${appLocale.interfaces.http_interface.method_arrow} 
                                ${subDomain}. 200 ${appLocale.interfaces.http_interface.method_ok}`);
                        res.status(200).send(`${callback}`);
                    });
